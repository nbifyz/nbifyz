...
**Input**: Design documents from `app-create/specs/[###-feature-name]/`
...
### Tests for User Story 1 (OPTIONAL - if tests requested) ⚠️
...
### Tests for User Story 2 (OPTIONAL - if tests requested) ⚠️
...
- [ ] T021 [US2] Implement [Service] in src/services/[entity].py
...
### Tests for User Story 3 (OPTIONAL - if tests requested) ⚠️
...
- [ ] T027 [US3] Implement [Service] in src/services/[entity].py
